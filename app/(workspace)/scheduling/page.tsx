        ...
        <CardContent className="space-y-2">
          {unscheduled.length === 0 && (
            <div className="rounded-xl border border-dashed border-zinc-200 p-4 text-center text-sm text-zinc-500">
              ...
              <Link href="/command-center" className="font-medium text-zinc-900 underline-offset-2 hover:underline">
                Command Center
              </Link>
            </div>
          )}
                    ...
                    {assigned.map((item) => (
                      ...
                      >
                        ...
                        <div className="mt-1 flex items-center justify-between gap-2">
                          <span className="text-[10px] text-zinc-500">{item.scheduledAt ? format(new Date(item.scheduledAt), "p") : "10:00 AM"}</span>
                          <button
                            type="button"
